...
def _strip_heuristic_prompt_lists(payload: dict[str, Any]) -> dict[str, Any]:
    """清理 prompts 里的关键词词表，避免回填成“关键词路由”。"""
...
def _built_in_config_defaults() -> dict[str, Any]:
    ...
    return {
        ...
        "memory": {
            ...
            "agent_directive_cues": [],
            "agent_directive_target_cues": [],
        },
        "knowledge_update": {
            "explicit_fact_cues": [],
            "speculative_cues": [],
        ...
        "bot": {
            ...
            "voice_send_try_full_first": False,
            ...
            "short_ping_phrases": ["yuki", "雪", "在吗", "在不在", "喂", "yo"],
            "short_ping_require_directed": False,
